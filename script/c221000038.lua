...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(s.cfilter,1,nil,1-tp) and Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsSetCard,0x7bd),e:GetHandler():GetControler(),LOCATION_MZONE,0,1,e:GetHandler())
end
