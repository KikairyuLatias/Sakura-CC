...
function s.filter(c,e,tp)
	return c:IsSetCard(0x122) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id) and not c:IsHasEffect(EFFECT_NECRO_VALLEY)
end
...
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ep~=tp and tc:IsControler(tp) and tc:IsSetCard(0x122)
end
