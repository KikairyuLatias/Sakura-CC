...
function s.sccon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_PZONE,0,1,e:GetHandler(),0x5f1)
end
function s.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterEffect(e1)
	local e0=e1:Clone()
	e0:SetCode(EFFECT_CHANGE_RSCALE)
	c:RegisterEffect(e0)
