...
function s.limfilter(c,sp)
	return c:IsSetCard(0x5f4) and c:IsFaceup() and c:IsSummonPlayer(sp)
end
...
function s.spfilter(c,e,tp,lv)
	return c:IsSetCard(0x5f4) and c:HasLevel() and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and (c:GetLevel()<=lv+3 and c:GetLevel()>lv)
end
