--Cherry Rabbit Gathering
local s,id=GetID()
function s.initial_effect(c)
	--Special Summon 1 "Cherry Rabbit" monster
	...
	c:RegisterEffect(e1)
	--Special Summon 2 "Cherry Rabbit" monsters with different names
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x7db) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
