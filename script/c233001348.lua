--Haruka the Flash Blossom Reindeer
local s,id=GetID()
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--cannot target other Flash Blossoms
	...
	e2:SetValue(s.atktg)
	c:RegisterEffect(e2)
	--block attacks on summoning turn
...
function s.atktg(e,c)
	return c:IsFaceup() and c~=e:GetHandler() and c:IsSetCard(0x4c8)
end

--lock off attacks from fresh monsters
