--Dasher, Radiant Dragon Reindeer of Racing Flash
local s,id=GetID()
function s.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x96c))
	c:RegisterEffect(e3)
	...
	e4:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x96c))
...
function s.tgfilter(c)
	return c:IsSetCard(0x96c) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
