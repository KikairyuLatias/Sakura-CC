...
function s.initial_effect(c)
	--Special Summon "Radiant Dragon Reindeer" monsters
...
--let's bring happiness to all the good children in the world
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x96c) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
