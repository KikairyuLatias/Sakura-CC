--Sapphire☆Dream Flagbearer Rider Yuki
local s,id=GetID()
function s.initial_effect(c)
	--materials
	Synchro.AddProcedure(c,nil,1,1,aux.FilterSummonCode(233001429),1,1)
	c:EnableReviveLimit()
...
--kirin stuff
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x7de) and c:IsAbleToHand()
end
