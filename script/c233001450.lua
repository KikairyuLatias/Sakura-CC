--Resistance★Dragon Scarlet Resolve
local s,id=GetID()
function s.initial_effect(c)
	--Special Summon 1 "Resistance★Dragon" monster
	...
	c:RegisterEffect(e1)
	--Special Summon 2 "Resistance★Dragon" monsters with different names
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x7dc) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
