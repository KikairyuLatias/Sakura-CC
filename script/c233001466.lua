--Ichigo the Starry Skystorm Blossom Rabbit
local s,id=GetID()
...
function s.tkfilter(c)
   return c:IsSetCard(0x7f3) and c:IsAbleToRemoveAsCost() and aux.SpElimFilter(c,true)
end

function s.tkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.rmcfilter,tp,LOCATION_GRAVE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,s.rmcfilter,tp,LOCATION_GRAVE,0,1,1,nil,tp)
