--Hinata the Starry Skystorm Blossom Rabbit
local s,id=GetID()
function s.initial_effect(c)
	...
	c:RegisterEffect(e3)
	--add "Starry Skystorm Blossom Rabbit" monster to hand
...
function s.cfilter(c)
	return c:IsFacedown() or not c:IsSetCard(0x7f3)
end
...
function s.sfilter(c)
	return c:IsSetCard(0x7f3) and c:IsAbleToHand() and c:IsMonster()
end
