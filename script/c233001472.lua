--Starry Skystorm Blossom Rabbit Deployment
local s,id=GetID()
function s.initial_effect(c)
	--Special Summon 1 "Starry Skystorm Blossom Rabbit" monster
	...
	c:RegisterEffect(e1)
	--Special Summon 2 "Starry Skystorm Blossom Rabbit" monsters with different names
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x7f3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
