--Starry Skystorm Thousand Blossom Strike
local s,id=GetID()
...
function s.lmfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x7f3) and c:IsType(TYPE_SYNCHRO+TYPE_MONSTER)
end
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	--if you got a synchro monster (and still want to just destroy)
