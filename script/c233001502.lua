--Dancer the Flash Resistance Reindeer
local s,id=GetID()
...
function s.atlimit(e,c)
	return c:IsFaceup() and c:IsSetCard(0x4ca) and c~=e:GetHandler()
end

--kirin
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x4ca) and c:IsAbleToHand()
end
