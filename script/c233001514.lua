--Flash Resistance Reindeer Light Resonating
local s,id=GetID()
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentChain(true)==0 and eg:IsExists(Card.IsSummonPlayer,1,nil,1-tp)
		and Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,0x4ca),tp,LOCATION_MZONE,0,1,nil)
end
...
function s.actcon(e)
	...
	return Duel.GetMatchingGroup(Card.IsSetCard,c:GetControler(),LOCATION_MZONE,0,nil,0x4ca):GetClassCount(Card.GetCode)>=3
end