--Dasher the Starry Snow Blossom Reindeer
local s,id=GetID()
function s.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0xa34))
	c:RegisterEffect(e3)
	...
	e4:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0xa34))
...
function s.tgfilter(c)
	return c:IsSetCard(0xa34) and c:IsAbleToGrave()
end
