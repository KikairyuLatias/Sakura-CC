--Blitzen the Starry Snow Blossom Reindeer
local s,id=GetID()
...
function s.dcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ep~=tp and tc:IsSetCard(0xa34) and tc:GetBattleTarget()~=nil
end
...
function s.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rc:IsRelateToBattle() and rc:IsStatus(STATUS_OPPO_BATTLE)
		and rc:IsFaceup() and rc:IsSetCard(0xa34) and rc:IsControler(tp)
end
