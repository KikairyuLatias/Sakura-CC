--Starry Snow Blossom Reindeer Sapphire Dance
local s,id=GetID()
...
function s.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xa34) and c:IsType(TYPE_MONSTER)
end
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	--if you got a synchro monster (and still want to just shuffle into deck)
