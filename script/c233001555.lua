--Riku the Starblossom Reindeer Athlete
local s,id=GetID()
function s.initial_effect(c)
	...
	e4:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x4cb))
	c:RegisterEffect(e4)
	...
	e5:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x4cb))
...
function s.tgfilter(c)
	return c:IsSetCard(0x4cb) and c:IsAbleToGrave()
end
