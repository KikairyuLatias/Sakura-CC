--Starblossom Opening Ceremony
local s,id=GetID()
function s.initial_effect(c)
	--Special Summon 1 "Stablossom Reindeer" monster
	...
	c:RegisterEffect(e1)
	--Special Summon 2 "Stablossom Reindeer" monsters with different names
	local e2=e1:Clone()Effect.CreateEffect(c)
...
function s.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not c:IsSetCard(0x4cb)
end

--summon 1
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x4cb) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
