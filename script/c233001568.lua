...
function s.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x4cb) and c:IsType(TYPE_MONSTER)
end
...
function s.cfilter2(c)
	return c:IsFaceup() and c:IsSetCard(0x4cb) and c:IsType(TYPE_SYNCHRO)
end
